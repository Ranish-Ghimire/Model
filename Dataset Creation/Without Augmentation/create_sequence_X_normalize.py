...
def create_sequences(data_dir, seq_length, stride, output_x_path, output_y_path):
    ...
    for class_name in class_labels:
        ...
        print(f"Number of sequences in {class_name}: {((len(frame_files) - seq_length) // stride) + 1}")
...
data_directory = r"E:/PosePerfect/Frames"
SEQ_LENGTH = 15
STRIDE = 15

output_x_path = 'X_orig_testing.dat'
output_y_path = 'y_orig_testing.dat'
